  ...
  return (
    <Link to="/izle?f=123asdf235123">
      <div className="flex mr-1 mb-6">
        <div className="flex relative inline-block mr-2" style={{ width: "210px", height: "124px" }}>
        ...
        <div className="flex-1">
          <div title="asdfasdf asdfasdf asdfasdf asdfasdf asdfasdf asdfasdf asdfasdf asdfasdf" className="flex text-white mb-4 text-2xl font-medium movie-desc">
